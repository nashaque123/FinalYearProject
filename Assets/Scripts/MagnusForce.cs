...
public class MagnusForce : MonoBehaviour
{
    ...
    public void CalculateBallAngularVelocity(float angleInRadians)
    {
        ...
        _angularVelocity = new Vector3(_spinRatePerPixel * differenceBetweenBallAndCursorOnAxes.x * Mathf.Cos(angleInRadians), _spinRatePerPixel * differenceBetweenBallAndCursorOnAxes.y, _spinRatePerPixel * -differenceBetweenBallAndCursorOnAxes.x * Mathf.Sin(angleInRadians));
    }
}
